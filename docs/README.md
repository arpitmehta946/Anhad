...
| **[`ONBOARDING.md`](./ONBOARDING.md)** | What should the japa first-run and returning experience actually be? Competitor research across ~15 japa/mala apps, the recommended four-screen first-run flow, and the "Sankalp" reframing of the existing streak feature. Supersedes `USER_FLOWS.md`'s open question for japa specifically — feed onboarding is still undecided. |
