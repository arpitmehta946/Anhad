...
| **[`ONBOARDING.md`](./ONBOARDING.md)** | What does a new person see first, and why do they come back? Competitor research across ~15 japa/mala apps, real user complaints, the "Sankalp" reframing of the streak feature, the four-screen first-run flow, the returning-user experience, and what the August 18 scope decisions (age gating, Family Accounts, singing-only scope) change about onboarding. Supersedes `USER_FLOWS.md`'s open question for japa specifically — feed onboarding is still undecided. |
